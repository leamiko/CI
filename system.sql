...
CREATE TABLE IF NOT EXISTS `pg_model` (
  ...
  `fields` text DEFAULT NULL COMMENT '字段集合',
  `parent` int(11) NOT NULL DEFAULT '0' COMMENT '父节点ID',
  `status` int(1) NOT NULL DEFAULT '0' COMMENT '状态/*安装||卸载=>1||0*/',
  `time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模型系统' AUTO_INCREMENT=1 ;
