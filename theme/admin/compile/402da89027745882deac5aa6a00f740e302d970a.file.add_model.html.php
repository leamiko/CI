<?php /* Smarty version Smarty-3.1.19, created on 2014-08-29 18:41:35
...
<?php if ($_valid && !is_callable('content_53fc977328c584_12975063')) {function content_53fc977328c584_12975063($_smarty_tpl) {?>		<div class="row">
								...
								<section>
									...
									<div class="btn-group">
										<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
											字段集合 <span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
											<li>
												<a href="javascript:void(0);" id="add">新建字段</a>
											</li>
											<li class="divider"></li>
											<li>
		...
		<script type="text/plain" id="model_tree"></script>
				...
				<fieldset>
					<div class="row">
						<section class="col col-6">
							...
							<label class="input">
								  <input data-rules="{required:true}" name="name" type="text">
							</label>
						</section>
						<section class="col col-6">
							<label class="label">注释</label>
							<label class="input">
								  <input data-rules="{required:true}" name="comment" type="text">
							</label>
						</section>
					</div>
					<section>
						...
						<label class="select">
							<select class="column_type" name="type">
					...
					<div class="row">
						<section class="col col-6">
							...
							<label class="input">
								  <input data-rules="{required:true}" name="length" type="text">
							</label>
						</section>
						<section class="col col-6">
							<label class="label">默认值</label>
							<label class="input">
								  <input data-rules="{required:true}" name="default" type="text">
							</label>
						</section>
					</div>
					<div class="row">
						<section class="col col-6">
							<label class="label">表单类型</label>
							<label class="select">
								<select name="form_id">
						...
						<section class="col col-6">
							...
							<label class="select">
								<select name="validate" class="custom-scroll">
									<option value="email">默认</option>
									<option value="email">必填</option>
			...
			$(function(){
				...
				$('#save').bind('click',function(){
					...
					if(container.valid()){
						...
						if(window.data.fields.length === 0){
							return $('#add').trigger('click');
						}
						$(me).attr('disabled',true);
						console.log(window.data.fields.length);
						return;
						setTimeout(function(){
							$.ajax({
